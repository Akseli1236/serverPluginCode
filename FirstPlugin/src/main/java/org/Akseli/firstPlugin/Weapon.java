...
public class Weapon {
    ...
    private static String getJarDirectoryPath() {
        File jarFile = new File(Weapon.class.getProtectionDomain().getCodeSource().getLocation().getPath());
    ...
    public static void readFile() {
        ...
        //ammos.forEach((key, value) -> System.out.println(key + ":" + value));
        //projectiles.forEach((key, value) -> System.out.println(key + ":" + value));
    }
